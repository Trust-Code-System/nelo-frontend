...
export type CartLineFragment = { id: string, quantity: number, linePriceWithTax: number, unitPriceWithTax: number, featuredAsset: { id: string, preview: string } | null, productVariant: { id: string, name: string, sku: string, product: { slug: string }, options: Array<{ id: string, code: string, name: string, groupId: string }> } } & { ' $fragmentName'?: 'CartLineFragment' };

export type CartFragment = { __typename: 'Order', id: string, code: string, state: string, active: boolean, currencyCode: CurrencyCode, totalQuantity: number, subTotalWithTax: number, shippingWithTax: number, totalWithTax: number, lines: Array<{ ' $fragmentRefs'?: { 'CartLineFragment': CartLineFragment } }> } & { ' $fragmentName'?: 'CartFragment' };

export type ActiveOrderQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveOrderQuery = { activeOrder: { ' $fragmentRefs'?: { 'CartFragment': CartFragment } } | null };
...
export type SearchCatalogueQuery = { search: { totalItems: number, items: Array<{ ' $fragmentRefs'?: { 'ProductCardFragment': ProductCardFragment } }>, facetValues: Array<{ count: number, facetValue: { id: string, name: string, code: string, facet: { id: string, name: string, code: string } } }> } };
